...
export default function SignUpForm() {
  ...
  const inputBase =
    "w-full pl-11 pr-4 py-3 border rounded-lg  transition-all duration-300 outline-none hover:border-[#45767C] hover:bg-white hover:shadow-md hover:shadow-[#9CBFAC]/50 focus:ring-2 focus:ring-[#719D99] focus:border-transparent";
  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        className="bg-blue-500 text-white px-4 py-2 my-3 rounded ml-auto disabled:bg-blue-300 w-full"
      >
