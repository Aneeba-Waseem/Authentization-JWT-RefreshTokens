...
const LoginForm = ({ setFormType }) => {
  ...
  return (
    <div className="flex flex-col gap-4 w-full max-w-md px-6 mx-auto">
      {/* Back Button */}
      <button
        type="button"
      ...
      <form onSubmit={handleSubmit}>
        <div className="">
          {/* Email */}
          <label className="block mb-2 mt-3 text-left">Email</label>
          <input
            type="email"
            name="email"
          ...
          <div className="relative w-full mb-4">
            <label className="block mb-2 mt-3 text-left">Password</label>
            <input
          ...
          {/* Buttons */}
            <button
              type="submit"
              disabled={loading}
              className="bg-blue-500 text-white px-4 py-2 my-2 w-full rounded ml-auto disabled:bg-blue-300"
            >
